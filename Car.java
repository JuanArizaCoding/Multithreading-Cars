        ...
        if (cartype == REDCAR) {
            if (inFront.getX() - xpos > 100) {
                ...
                if (xpos >= bridgeXLeft & xposOld < bridgeXLeft) {
                	//System.out.println("enter al left de pintar");
                	...
                	//System.out.println("leave al right de pintar");
            ...
            if (xpos - inFront.getX() > 100) {
                ...
                if (xpos <= bridgeXRight && xposOld > bridgeXRight) {
                	//System.out.println("enter al right de pintar");
                	...
                	//System.out.println("leave al left de pintar");
